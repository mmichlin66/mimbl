import { CallbackWrappingOptions, ComponentShadowOptions, IComponent, ICustomAttributeHandlerClass, IRef, ITextVN, IVNode, PromiseProxyProps, RefFunc, RenderMethodType, DN, IComponentEx } from "./CompTypes";
...
export declare abstract class Component<TProps extends {} = {
    children?: any;
}, TEvents extends {} = {}> extends EventTarget implements IComponent<TProps>, IComponentEx {
    /**
