import {
    IElementProps, ReferrerPolicyPropType, FormtargetPropType, CrossoriginPropType, ExtendedElementProps
} from "./mim";
...
{
    svg: ExtendedElementProps<ISvgSvgElementProps>;
    svgA: ExtendedElementProps<ISvgAElementProps>;
    animate: ExtendedElementProps<ISvgConditionalProcessingProps | ISvgAnimationProps>;
    animateMotion: ExtendedElementProps<ISvgAnimateMotionElementProps>;
    animateTarnsform: ExtendedElementProps<ISvgConditionalProcessingProps | ISvgAnimationProps>;
    circle: ExtendedElementProps<ISvgCircleElementProps>;
    clipPath: ExtendedElementProps<ISvgClipPathElementProps>;
    colorProfile: ExtendedElementProps<ISvgColorProfilePathElementProps>;
    defs: ExtendedElementProps<ISvgElementProps>;
    desc: ExtendedElementProps<ISvgElementProps>;
    discard: ExtendedElementProps<ISvgDiscardElementProps>;
    ellipse: ExtendedElementProps<ISvgEllipseElementProps>;
    feBlend: ExtendedElementProps<ISvgFeBlendElementProps>;
    feColorMatrix: ExtendedElementProps<ISvgFeColorMatrixElementProps>;
    feComponentTransfer: ExtendedElementProps<ISvgFeComponentTransferElementProps>;
    feComposite: ExtendedElementProps<ISvgFeCompositeElementProps>;
    feConvolveMatrix: ExtendedElementProps<ISvgFeConvolveMatrixElementProps>;
    feDiffuseLighting: ExtendedElementProps<ISvgFeDiffuseLightingElementProps>;
    feDisplacementMap: ExtendedElementProps<ISvgFeDisplacementMapElementProps>;
    feDistantLight: ExtendedElementProps<ISvgFeDistantLightElementProps>;
    feDropShadow: ExtendedElementProps<ISvgFeDropShadowElementProps>;
    feFlood: ExtendedElementProps<ISvgFeFloodElementProps>;
    feFuncA: ExtendedElementProps<ISvgTransferFunctionsProps>;
    feFuncB: ExtendedElementProps<ISvgTransferFunctionsProps>;
    feFuncG: ExtendedElementProps<ISvgTransferFunctionsProps>;
    feFuncR: ExtendedElementProps<ISvgTransferFunctionsProps>;
    feGaussianBlur: ExtendedElementProps<ISvgFeGaussianBlurElementProps>;
    feImage: ExtendedElementProps<ISvgFeImageElementProps>;
    feMerge: ExtendedElementProps<ISvgPresentationProps | ISvgFilterPrimitiveProps>;
    feMergeNode: ExtendedElementProps<ISvgFeMergeNodeElementProps>;
    feMorphology: ExtendedElementProps<ISvgFeMorphologyElementProps>;
    feOffset: ExtendedElementProps<ISvgFeOffsetElementProps>;
    fePointLight: ExtendedElementProps<ISvgFePointLightElementProps>;
    feSpecularLighting: ExtendedElementProps<ISvgFeSpecularLightingElementProps>;
    feSpotLight: ExtendedElementProps<ISvgFeSpotLightElementProps>;
    feTile: ExtendedElementProps<ISvgFeTileElementProps>;
    feTurbulence: ExtendedElementProps<ISvgFeTurbulenceElementProps>;
    filter: ExtendedElementProps<ISvgFilterElementProps>;
    foreignObject: ExtendedElementProps<ISvgForeignObjectElementProps>;
    g: ExtendedElementProps<ISvgConditionalProcessingProps | ISvgPresentationProps>;
    hatch: ExtendedElementProps<ISvgHatchElementProps>;
    hatchpath: ExtendedElementProps<ISvgHatchpathElementProps>;
    image: ExtendedElementProps<ISvgImageElementProps>;
    line: ExtendedElementProps<ISvgLineElementProps>;
    linearGradient: ExtendedElementProps<ISvgLinearGradientElementProps>;
    marker: ExtendedElementProps<ISvgMarkerElementProps>;
    mask: ExtendedElementProps<ISvgMaskElementProps>;
    metadata: ExtendedElementProps<ISvgElementProps>;
    mpath: ExtendedElementProps<ISvgMPathElementProps>;
    path: ExtendedElementProps<ISvgPathElementProps>;
    pattern: ExtendedElementProps<ISvgPatternElementProps>;
    polygon: ExtendedElementProps<ISvgPolygonElementProps>;
    polyline: ExtendedElementProps<ISvgPolylineElementProps>;
    radialGradient: ExtendedElementProps<ISvgRadialGradientElementProps>;
    rect: ExtendedElementProps<ISvgRectElementProps>;
    svgScript: ExtendedElementProps<ISvgScriptElementProps>;
    set: ExtendedElementProps<ISvgSetElementProps>;
    solidcolor: ExtendedElementProps<ISvgElementProps>;
    stop: ExtendedElementProps<ISvgStopElementProps>;
    svgStyle: ExtendedElementProps<ISvgStyleElementProps>;
    switch: ExtendedElementProps<ISvgConditionalProcessingProps | ISvgPresentationProps>;
    symbol: ExtendedElementProps<ISvgSymbolElementProps>;
    text: ExtendedElementProps<ISvgTextElementProps>;
    textPath: ExtendedElementProps<ISvgTextPathElementProps>;
    svgTitle: ExtendedElementProps<ISvgElementProps>;
    textSpan: ExtendedElementProps<ISvgTextSpanElementProps>;
    use: ExtendedElementProps<ISvgUseElementProps>;
    view: ExtendedElementProps<ISvgViewElementProps>;
}
