...
/// #endif
	...
	public static findVN( func: Function, key?: any): FuncProxyVN
	{
		// if the key is undefined, we use the function object itself
		let linkKey: any = key || s_currentClassComp || func;
	...
	public static update( func: Function, key?: any, args?: any[]): void
	{
		// find the node
		let vn = FuncProxyVN.findVN( func, key);
		if (!vn)
			return;
